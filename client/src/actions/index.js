...
import {
    ...
    SET_IS_PLAYING,
    SET_VOLUME,
    SET_INTERVAL_ID_FLAG,
    SET_TIME,
    IS_MUSIC_KIT_AUTHORIZED,
    DELETE_POST,
    ...
    FETCH_ALL_FOLLOWER_POSTS_COUNT,
    FETCH_ALL_USER_POSTS_COUNT,
    SEARCH_USERS,
    CLEAR_USER_STATE,
    CLEAR_POSTS_STATE,
    SONG_LOADING
...
export const continuefetchUserPosts = (
    username,
    page,
    take
) => async dispatch => {
